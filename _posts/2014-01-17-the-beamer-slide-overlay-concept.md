...
tags:
  - overlays
---
There was a [question recently](http://tex.stackexchange.com/questions/154521) on the [TeX StackExchange site](http://tex.stackexchange.com) about the details of how slide overlays work in the [`beamer`](http://ctan.org/pkg/beamer) class. The question itself was about a particular input syntax, but it prompted me to think that a slightly more complete look at overlays would be useful.
